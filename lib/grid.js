...
var pullTile = this.pullTile;
var compareTile = this.compareTile;
var equalTiles = (pullTile.data === compareTile.data);
var nullTiles = (compareTile.data === null);
function multiply() {
  (compareTile.data *= 2);
}
function smush() {
  compareTile.data = compareTile.next.data;
}
