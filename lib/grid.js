...
// case comparetile null
    ...
    if (pullTile[direction][direction] === null){
      console.log('2 tiles in a row are null');
      console.log(pullTile.position, 'this is pull');
      console.log(compareTile.position, 'this is compare');
    }
